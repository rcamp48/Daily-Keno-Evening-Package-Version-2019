...
REM
REM *** Last Update : November 24 2018 - 4:00 PM
REM
...
LOCATE 6, 11
PRINT "     Daily Keno Package Version 2019 Copyright (c) 2018   "
...
ELSEIF answer$ = "%" THEN
    ...
    serial$ = reg2$
    version$ = "2019"
    release$ = "November 24 2018 - 4:00 PM"
    pass$ = "Omnimon43"
    IF pass2$ = pass$ THEN
        CLS
        PRINT
...
IF crs$ = "Y" THEN COLOR 10, 5
LOCATE 3, 7
PRINT "          Daily Keno  2019  Barchart Menu            "
LOCATE 13, 7
...
linecounter = 0
ERASE chart
OPEN "kenonumbers2.dat" FOR INPUT AS #1
DO UNTIL EOF(1)
    INPUT #1, dat$
    PRINT dat$
    INPUT #1, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t
    PRINT a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t
    REM chart(linecounter, 1) = month
    REM chart(linecounter, 2) = day
    REM chart(linecounter, 3) = year
    ...
    IF linecounter > EOF(1) THEN GOTO fini
    linecounter = linecounter + 1
...
PRINT "Covering the period from "; month$(monthin); yearin; " to "; month$(monthend); yearend
LOCATE 21, 12
PRINT "00000000011111111112222222222333333333344444444445555555555566666666667777777777"
LOCATE 22, 12
